...
const PureSEO = props => {
  ...
  const url = `${config.url}${pathPrefix}`
  const image = `${url}${config.logo}`
  ...
  const schemaOrgWebPage = {
    ...
    '@type': 'WebPage',
    url: url,
    PureSEOline: config.sitePureSEOline,
    inLanguage: 'en',
...
const SEO = props => <StaticQuery query={querySEO} render={data => <PureSEO {...props} data={data} />} />
